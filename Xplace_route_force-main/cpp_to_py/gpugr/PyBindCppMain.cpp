...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    pybind11::class_<gr::RouteForce, std::shared_ptr<gr::RouteForce>>(m, "RouteForce")
        ...
        .def("net_to_node_force", &gr::RouteForce::netToNodeForce, py::return_value_policy::move)
        .def("calc_net_center_pos", &gr::RouteForce::calcNetCenterPos, py::return_value_policy::move);
