...
def get_option():
    ...
    parser.add_argument('--design_name', type=str, default='mgc_fft_a', help='design name')
    ...
    parser.add_argument('--num_route_iter', type=int, default=5, help='number of routing iters')
